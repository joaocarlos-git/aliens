...
class Scoreboard():
    ...
    def show_score(self):
        """Desenha as pontuaçoes e o nivel na tela."""
    ...
    def prep_level(self):
        """Tranforma o nivel em uma imagem renderizada"""
        self.level_image = self. font.render(str(self.stats.level), True, self.
        text_color, self.ai_settings.bg_color)
